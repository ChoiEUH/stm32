...
/* Definitions for qmcTask */
osThreadId_t qmcTaskHandle;
const osThreadAttr_t qmcTask_attributes = {
  .name = "qmcTask",
  .stack_size = 128 * 4,
...
/**
  * @brief  Function implementing the qmcTask thread.
...
/* USER CODE BEGIN Header_tempTask02 */
/**
