...
/* Definitions for qmcTask_Init */
osThreadId_t qmcTask_InitHandle;
const osThreadAttr_t qmcTask_Init_attributes = {
  .name = "qmcTask_Init",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for BTTask_Init */
osThreadId_t BTTask_InitHandle;
const osThreadAttr_t BTTask_Init_attributes = {
  .name = "BTTask_Init",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
/* USER CODE BEGIN Header_qmcTask */
/**
  * @brief  Function implementing the qmcTask_Init thread.
...
/**
* @brief Function implementing the BTTask_Init thread.
* @param argument: Not used
* @retval None
*/
